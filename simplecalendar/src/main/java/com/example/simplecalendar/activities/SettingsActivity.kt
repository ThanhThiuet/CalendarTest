...
import com.example.simplecalendar.dialogs.SelectCalendarsDialog
...
//            startCustomizationActivity() => error
    ...
    private fun setupReminderSound() {
        ...
        settings_reminder_sound_holder.setOnClickListener {
            config.reminderSoundUri?.let { it1 ->
                SelectAlarmSoundDialog(this, it1, config.reminderAudioStream, GET_RINGTONE_URI, ALARM_SOUND_TYPE_NOTIFICATION, false,
                        onAlarmPicked = {
                            if (it != null) {
